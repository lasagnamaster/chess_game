...
sounds_names = ['moving_piece1.wav','moving_piece2.wav','moving_piece3.wav','moving_piece4.wav','moving_piece5.wav', 'moving_piece6.wav',
                ...
                'pistol_shot.wav','pistol_reload.wav','rifle_shot.wav','rifle_shot1.wav','rifle_shot2.wav','rifle_reload.wav',
                'rifle_reload1.wav', 'rifle_reload2.wav']
SOUNDS = [pygame.mixer.Sound('sounds/sfx/'+path) for path in sounds_names]

visuals_names = ['clipart-2d-chess-set-chessboard-512x512-e3cb.png', 'green.png', 'menu-back.png', 'background.png', 'menu_pause_background.png',
                 'red.png']
VISUALS_PICS = [pygame.image.load('images/visuals/'+path) for path in visuals_names]

gun_names = ['Bazooka.png', 'Arisaka.png', 'PPSh.png', 'Mosin.png', 'DP 28.png', 'bar.png', 'gun3.png']
GUN_PICS = [pygame.image.load('images/visuals/guns/'+path) for path in gun_names]
